...
('PENDING_REVIEW', 'user comment 3', 'http://fake.com', '/fakepath',3,3, current_timestamp, current_timestamp, 3),
...
('PENDING_REVIEW', 'user comment 9', 'http://web.com', '/webpath',4,1, current_timestamp, current_timestamp, 3);
