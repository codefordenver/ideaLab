...
public class PrintJobOperationsTest {
    ...
    public void createNewPrintJob() {
        ...
        when(dropboxService.uploadDropboxFile(anyLong(), any())).thenReturn(data);
    ...
    public void updateModelSuccess() {
        ...
        when(dropboxService.updateDropboxFile(printJob, request.getFile())).thenReturn(data);
        when(printJobRepo.save(printJob)).thenReturn(printJob);
    ...
    public void updateModelDropboxFail() {
        ...
        when(printJobRepo.findPrintJobById(printJob.getId())).thenReturn(printJob);
        when(dropboxService.updateDropboxFile(printJob, request.getFile())).thenThrow(new IdeaLabApiException(DROPBOX_UPLOAD_FILE_ERROR));
    ...
    public void deleteModelSuccess() {
        ...
        when(printJobRepo.findPrintJobById(printJob.getId())).thenReturn(printJob);
        doNothing().when(dropboxService).deleteDropboxFile(printJob.getFilePath());
        when(printJobRepo.save(printJob)).thenReturn(printJob);
